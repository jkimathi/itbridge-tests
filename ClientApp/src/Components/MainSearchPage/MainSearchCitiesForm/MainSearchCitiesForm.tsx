...
const MainSearchCitiesForm = ({ setState_events_data, setStateIsSearchInProgress, setStateIsSearchResultEmpty }: ISearchCityProps) => {
    ...
    //handle destination input clickaway
                        ...
                        <div className="col-xl-7">
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className={stateOriginResultVisibility ? "form-column booking-form-origin booking-form-origin-visible" : "form-column booking-form-origin booking-form-origin-not-visible"}>
                                ...
                                <div className="col-lg-6">
                                    <div className={stateDestinationResultVisibility ? "form-column booking-form-destination booking-form-destination-visible" : "form-column booking-form-destination booking-form-destination-not-visible"}>
                                        <div className="search-controls">
                                            <LocationOnIcon className="icon" style={{ fontSize: 16 }} />
                                            <input className="booking-select" type="search"
                                                autoComplete="off"
                        ...
                        <div className="col-xl-5">
                            <div className="row">
                                <div className="col-md-7 col-lg-6 col-xl-7">
                                        <div className="form-column booking-form-start">
                                ...
                                <div className="col-md-5 col-lg-6 col-xl-5">
                                    <div className="form-column booking-form-btn">
...
export default MainSearchCitiesForm
